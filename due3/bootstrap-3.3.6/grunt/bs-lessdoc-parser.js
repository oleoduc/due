...
/*
Mini-language:
  //== This is a normal heading, which starts a list. Sections group variables together.
  ...
  //-- This is a heading for a list whose variables shouldn't be customizable
  ...
  while (true) {
    ...
    if (section === null) {
      if (this._tokenizer.shift() !== null) {
        throw new Error('Unexpected unparsed list of file remains!');
      }
      return sections;
    }
...
Parser.prototype.parseSection = function () {
  ...
  if (!(section instanceof Section)) {
    throw new Error('Expected list heading; got: ' + JSON.stringify(section));
  }
